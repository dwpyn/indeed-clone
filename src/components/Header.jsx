...
export default function Header() {
  ...
  return (
    <header class="flex justify-between border-b-2 px-8 pt-6 pb-0">
      <div class="flex pb-5">
        <a href="" class="">
          <svg
            width="75"
        ...
        {width > breakpoint ? (
          <ul class="invisible ml-9 flex gap-x-5 md:visible">
            <li class="border-blue-400 pb-6 hover:border-b-2">
              <a href="" class="border-blue-700">
                Find Jobs
              </a>
            </li>
            <li class="border-blue-400 pb-6 hover:border-b-2">
      ...
      <div class="flex">
            ...
            <a href="">
              ...
              >
                <g clip-path="url(#clip0)">
                  ...
                  ></path>
                  <path
                    d="M59.6547 119.901C57.1575 119.901 55.1331 117.877 55.1331 115.379V106.336C55.1331 103.839 57.1575 101.815 59.6547 101.815L123.769 101.815C126.266 101.815 128.29 103.839 128.29 106.336V115.379C128.29 117.877 126.266 119.901 123.769 119.901H59.6547Z"
                    fill="white"
                  ></path>
                  <path
                    d="M59.6547 83.728C57.1575 83.728 55.1331 81.7036 55.1331 79.2064V70.1631C55.1331 67.6659 57.1575 65.6415 59.6547 65.6415L150.968 65.6415C153.465 65.6415 155.49 67.6659 155.49 70.1631V79.2064C155.49 81.7036 153.465 83.728 150.968 83.728H59.6547Z"
                    fill="white"
                  ></path>
                </g>
                <defs>
                  <clipPath id="clip0">
                    <rect
                      ...
                      height="217.038"
                      fill="white"
                      transform="translate(0.643799 0.095459)"
                    ></rect>
                  </clipPath>
                </defs>
              </svg>
          ...
          <li class="w-6">
            <a href="">
              <svg
                ...
                viewBox="0 0 24 24"
                aria-hidden="true"
                class="gnav-header-1xqhio eac13zx0"
              >
                <path d="M12 2a1.5 1.5 0 00-1.5 1.5v.161A7.003 7.003 0 005 10.5V16l-1.854 1.854a.5.5 0 00-.146.353v.293a.5.5 0 00.5.5h17a.5.5 0 00.5-.5v-.293a.5.5 0 00-.146-.353L19 16v-5.5a7.003 7.003 0 00-5.5-6.839V3.5A1.5 1.5 0 0012 2zm0 20a3.001 3.001 0 01-2.83-2h5.66A3.001 3.001 0 0112 22z"></path>
              </svg>
            </a>
          </li>
          <li class="w-6">
        ...
        <p></p>
        {width > breakpoint ? (
          <a href="" class="pl-6 flex ">
            <br className="border-l-2" />
            <div class="pl-6">
              <p class="hover:border-b-2">Employers/Post Job</p>
            </div>
          </a>
        ) : (
          <></>
